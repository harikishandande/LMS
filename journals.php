           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="journals.php"><i class="glyphicon glyphicon-list "></i>Journals</a>
                    </li>
					<li>
            ...
            <div id="page-inner">
				...
				<table class="table table-bordered ">
							...
							?>		
									<tr>
										<td>
											<a href="journals.php?jfile=<?php echo $journal['jfile'];?>"><?php echo $journal['jname']; ?></a>
										</td>
									</tr>
							<?php	}
									?>
							...
							<?php
								if(isset($_GET['jfile']))
								{
						?>			<label style="margin:10px 10px 10px 0px;">Loaded Journal</label><a href="journals.php" style="color:white;float:right;" class="btn btn-info"><b>x</b></a>
