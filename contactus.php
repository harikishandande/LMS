...
if(isset($_POST['send']))
{
	...
	else
	{
		...
		if($num==1)
		{	
			$query = $pdo->prepare('INSERT into contactus(staff_no,message)values(?,?)');
				$query->bindValue(1, $username);
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="contactus.php"><i class="glyphicon glyphicon-phone-alt "></i>Contact Us</a>
                    </li>	
                    <li>
