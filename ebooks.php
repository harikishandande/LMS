           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="ebooks.php"><i class="glyphicon glyphicon-book "></i>E-Book</a>
                    </li>
					<li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				...
				?>		
						<tr>
							<td>
								<a href="ebooks.php?efile=<?php echo $book['efile'];?>"><?php echo $book['ename']; ?></a>
							</td>
						</tr>
				<?php	}
						?>
				...
				<?php
					if(isset($_GET['efile']))
					{	
			?>			<label style="margin:10px 10px 10px 0px;">Loaded Ebook</label><a href="ebooks.php" style="color:white;float:right;" class="btn btn-info"><b>x</b></a>
